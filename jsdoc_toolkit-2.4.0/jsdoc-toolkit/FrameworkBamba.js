...
// TUNE CALLBACK'S
  ...
  function noMuteMode(){
	...
	function serviceDiscovery(){
		...
		$.ajax({
	  		type: "POST",
	  		url: "http://192.168.98.189:8080/IpServer/tv/save",
	  		data: { ipTV: "http://192.168.98.189:8008/ws/", tvappname:"FrameworkBamba_Test"},
  ...
  */
    ...
    /** @namespace 
     * Classe abstrata responsável pelo gerenciamento de uso/compartilhamento de teclas do controle remoto entre aplicações e a TV.
     **/
    var Keymanagement = {
...
/** @namespace 
 * Classe abstrata responsável pelo acesso as funcionalidades específicas (mudança automática de canais da TV, alteração automática de volumes, etc.) da TV. 
 **/
    var Tvcontrol = {
    ...
    /** @namespace 
     * Classe abstrata que contém interfaces para acesso as funcionalidades de detecção automática da id de um canal da TV.
     **/
    var Channelid = {
 ...
 **/
 ...
 /** @namespace
  * Classe abstrata que contém a interface de comunicação entre a TV e os dispositivos móveis. 
  **/   
      var Communication = {
   ...
   /** @namespace 
    * Classe responsável pela inicialização (First Setup) do Framework. 
    **/
     var Framework = {
